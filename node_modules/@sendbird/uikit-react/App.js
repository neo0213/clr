...
import { u as useVoicePlayerContext, a as ALL } from './chunks/bundle-Ku1a64TD.js';
...
import './chunks/bundle-wRCPXISN.js';
...
var DesktopLayout = function (props) {
    ...
    var _a = useState(null), animatedMessageId = _a[0], setAnimatedMessageId = _a[1];
    return (React__default.createElement("div", { className: "sendbird-app__wrap" },
        React__default.createElement("div", { className: "sendbird-app__channellist-wrap" },
            React__default.createElement(ChannelList, { allowProfileEdit: allowProfileEdit, activeChannelUrl: currentChannel === null || currentChannel === void 0 ? void 0 : currentChannel.url, onProfileEditSuccess: onProfileEditSuccess, disableAutoSelect: disableAutoSelect, onChannelSelect: function (channel) {
        ...
        React__default.createElement("div", { className: "\n          ".concat(showSettings ? 'sendbird-app__conversation--settings-open' : '', "\n          ").concat(showSearch ? 'sendbird-app__conversation--search-open' : '', "\n          sendbird-app__conversation-wrap\n        ") },
            React__default.createElement(Channel, { channelUrl: (currentChannel === null || currentChannel === void 0 ? void 0 : currentChannel.url) || '', onChatHeaderActionClick: function () {
                    setShowSearch(false);
                    setShowThread(false);
...
var MobileLayout = function (props) {
    ...
    var _e = useState(null), animatedMessageId = _e[0], setAnimatedMessageId = _e[1];
    ...
    return (React__default.createElement("div", { className: 'sb_mobile' },
        panel === PANELS.CHANNEL_LIST && (React__default.createElement("div", { className: 'sb_mobile__panelwrap' },
            React__default.createElement(ChannelList, { onProfileEditSuccess: onProfileEditSuccess, onChannelSelect: function (channel) {
                    setCurrentChannel(channel);
                    setPanel(PANELS.CHANNEL);
                }, allowProfileEdit: allowProfileEdit, 
                // this condition must be true for mobile
                disableAutoSelect: true }))),
        panel === PANELS.CHANNEL && (React__default.createElement("div", { className: 'sb_mobile__panelwrap' },
            React__default.createElement(Channel, { replyType: replyType, channelUrl: (currentChannel === null || currentChannel === void 0 ? void 0 : currentChannel.url) || '', onSearchClick: function () {
...
var AppLayout = function (props) {
    var _a, _b, _c;
    var isMessageGroupingEnabled = props.isMessageGroupingEnabled, allowProfileEdit = props.allowProfileEdit, onProfileEditSuccess = props.onProfileEditSuccess, disableAutoSelect = props.disableAutoSelect, currentChannel = props.currentChannel, setCurrentChannel = props.setCurrentChannel;
