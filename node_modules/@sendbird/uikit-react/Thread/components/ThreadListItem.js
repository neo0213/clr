import { _ as __assign, a as __spreadArray } from '../../chunks/bundle-Y6TqPszM.js';
...
import { R as RemoveMessage } from '../../chunks/bundle-ZNwxfYJx.js';
import { F as FileViewer } from '../../chunks/bundle-LTnLzJFb.js';
...
import { a as UserProfileContext } from '../../chunks/bundle-3WQuaADd.js';
import UserProfile from '../../ui/UserProfile.js';
import { MessageMenu } from '../../ui/MessageItemMenu.js';
import { MessageEmojiMenu } from '../../ui/MessageItemReactionMenu.js';
import { w as getUIKitMessageTypes, h as getSenderName, n as getClassName, I as isOGMessage, J as isTextMessage, i as isVoiceMessage, t as getUIKitMessageType, b as isMultipleFilesMessage, r as isThumbnailMessage } from '../../chunks/bundle-ZT6XnGSN.js';
import { M as MessageStatus } from '../../chunks/bundle-l0M5nN1Q.js';
...
import { M as MobileMenu } from '../../chunks/bundle-k4WuO78S.js';
...
import { R as Role } from '../../chunks/bundle-KOKqPpBq.js';
import { useDirtyGetMentions } from '../../Message/hooks/useDirtyGetMentions.js';
import { g as getIsReactionEnabled } from '../../chunks/bundle-QO9wq7-1.js';
    ...
    return (React__default.createElement("div", { className: "sendbird-thread-list-item-content ".concat(className, " ").concat(isByMe ? 'outgoing' : 'incoming'), ref: mobileMenuRef },
        React__default.createElement("div", { className: "sendbird-thread-list-item-content__left ".concat(isReactionEnabledInChannel ? 'use-reaction' : '', " ").concat(isByMe ? 'outgoing' : 'incoming') },
            (!isByMe && !chainBottom) && (React__default.createElement(ContextMenu, { menuTrigger: function (toggleDropdown) {
                ...
                }, menuItems: function (closeDropdown) { return (React__default.createElement(MenuItems, { parentRef: avatarRef, parentContainRef: avatarRef, closeDropdown: closeDropdown, style: { paddingTop: '0px', paddingBottom: '0px' } }, renderUserProfile
                    ? renderUserProfile({ user: message === null || message === void 0 ? void 0 : message.sender, close: closeDropdown, currentUserId: userId })
