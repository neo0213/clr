...
import { a as compareIds, s as scrollIntoLast, g as getParentMessageFrom, u as useSendMultipleFilesMessage, b as getNicknamesMapFromMembers } from '../chunks/bundle-EteEacTX.js';
import { U as UserProfileProvider } from '../chunks/bundle-3WQuaADd.js';
import { useSendbirdStateContext } from '../useSendbirdStateContext.js';
import { _ as __assign, a as __spreadArray, b as __awaiter, c as __generator } from '../chunks/bundle-Y6TqPszM.js';
import { ChannelStateTypes, ThreadListStateTypes, ParentMessageStateTypes } from './context/types.js';
import { ChannelType } from '@sendbird/chat';
import { p as pubSubTopics, a as shouldPubSubPublishToThread, b as PUBSUB_TOPICS, P as PublishingModuleType } from '../chunks/bundle-7x4clnC7.js';
import { s as ON_FILE_INFO_UPLOADED, t as ON_TYPING_STATUS_UPDATED } from '../chunks/bundle-GGcTNRCI.js';
import { GroupChannelHandler } from '@sendbird/chat/groupChannel';
import { u as uuidv4 } from '../chunks/bundle-8VA5hO1c.js';
import { c as compareIds$1 } from '../chunks/bundle-EPtYsHAJ.js';
import '../chunks/bundle-ZT6XnGSN.js';
import { SendingStatus, MessageType, MessageMetaArray } from '@sendbird/chat/message';
import { a as VOICE_MESSAGE_FILE_NAME, b as VOICE_MESSAGE_MIME_TYPE, M as META_ARRAY_VOICE_DURATION_KEY, i as META_ARRAY_MESSAGE_TYPE_KEY, j as META_ARRAY_MESSAGE_TYPE_VALUE__VOICE } from '../chunks/bundle-Sk3SXXP7.js';
...
function useGetThreadList(_a, _b) {
    var sdkInit = _a.sdkInit, parentMessage = _a.parentMessage, anchorMessage = _a.anchorMessage, isReactionEnabled = _a.isReactionEnabled;
    var logger = _b.logger, threadDispatcher = _b.threadDispatcher;
    useEffect(function () {
        var _a;
        // validation check
        if (sdkInit && (parentMessage === null || parentMessage === void 0 ? void 0 : parentMessage.getThreadedMessagesByTimestamp)) {
            ...
            (_a = parentMessage.getThreadedMessagesByTimestamp) === null || _a === void 0 ? void 0 : _a.call(parentMessage, timeStamp, params).then(function (_a) {
                var parentMessage = _a.parentMessage, threadedMessages = _a.threadedMessages;
                logger.info('Thread | useGetThreadList: Initialize thread list succeeded.', { parentMessage: parentMessage, threadedMessages: threadedMessages });
                threadDispatcher({
    ...
    var sendMessage = useCallback(function (file, quoteMessage) {
        return new Promise(function (resolve, reject) {
            ...
            currentChannel === null || currentChannel === void 0 ? void 0 : currentChannel.sendFileMessage(params).onPending(function (pendingMessage) {
                ...
                setTimeout(function () { return scrollIntoLast(); }, 1000);
...
function useGetPrevThreadsCallback(_a, _b) {
    var hasMorePrev = _a.hasMorePrev, parentMessage = _a.parentMessage, threadListState = _a.threadListState, oldestMessageTimeStamp = _a.oldestMessageTimeStamp, isReactionEnabled = _a.isReactionEnabled;
    var logger = _b.logger, threadDispatcher = _b.threadDispatcher;
    return useCallback(function (callback) {
        var _a;
        // validation check
        if (threadListState === ThreadListStateTypes.INITIALIZED
            && (parentMessage === null || parentMessage === void 0 ? void 0 : parentMessage.getThreadedMessagesByTimestamp)
            ...
            (_a = parentMessage.getThreadedMessagesByTimestamp) === null || _a === void 0 ? void 0 : _a.call(parentMessage, oldestMessageTimeStamp, {
                ...
                var parentMessage = _a.parentMessage, threadedMessages = _a.threadedMessages;
                logger.info('Thread | useGetPrevThreadsCallback: Fetch prev threads succeeded.', { parentMessage: parentMessage, threadedMessages: threadedMessages });
                threadDispatcher({
                    type: ThreadContextActionTypes.GET_PREV_MESSAGES_SUCESS,
                    payload: { parentMessage: parentMessage, threadedMessages: threadedMessages },
                });
...
function useGetNextThreadsCallback(_a, _b) {
    var hasMoreNext = _a.hasMoreNext, parentMessage = _a.parentMessage, threadListState = _a.threadListState, latestMessageTimeStamp = _a.latestMessageTimeStamp, isReactionEnabled = _a.isReactionEnabled;
    var logger = _b.logger, threadDispatcher = _b.threadDispatcher;
    return useCallback(function (callback) {
        var _a;
        // validation check
        if (threadListState === ThreadListStateTypes.INITIALIZED
            ...
            (_a = parentMessage.getThreadedMessagesByTimestamp) === null || _a === void 0 ? void 0 : _a.call(parentMessage, latestMessageTimeStamp, {
                ...
                var parentMessage = _a.parentMessage, threadedMessages = _a.threadedMessages;
                logger.info('Thread | useGetNextThreadsCallback: Fetch next threads succeeded.', { parentMessage: parentMessage, threadedMessages: threadedMessages });
                threadDispatcher({
