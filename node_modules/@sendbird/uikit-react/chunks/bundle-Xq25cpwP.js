...
function channelListReducer(state, action) {
    return (K(action)
        .with({ type: INIT_CHANNELS_START }, function () { return (__assign(__assign({}, state), { loading: true })); })
        ...
        return __assign(__assign({}, state), { initialized: true, loading: false, allChannels: channelList, disableAutoSelect: disableAutoSelect, currentChannel: !disableAutoSelect && channelList && channelList.length && channelList.length > 0 ? channelList[0] : null });
    })
        ...
        return __assign(__assign({}, state), { currentChannel: channelUrl === ((_a = state.currentChannel) === null || _a === void 0 ? void 0 : _a.url) ? state.allChannels[0] : state.currentChannel, allChannels: state.allChannels.filter(function (_a) {
                var url = _a.url;
        ...
        return __assign(__assign({}, state), { currentUserId: action.payload.currentUserId, channelListQuery: action.payload.channelListQuery });
    })
