...
import { a as __spreadArray, _ as __assign } from './bundle-Y6TqPszM.js';
...
import { L as LocalizationContext, u as useLocalization } from './bundle-Xly_X4hP.js';
...
function InviteUsers(_a) {
    ...
    var _e = useState([]), members = _e[0], setMembers = _e[1];
    var _f = useState({}), selectedMembers = _f[0], setSelectedMembers = _f[1];
    var _g = useState(null), userQuery = _g[0], setUserQuery = _g[1];
    var state = useSendbirdStateContext();
    ...
    var userFilledQuery = __assign({}, queries === null || queries === void 0 ? void 0 : queries.applicationUserListQuery);
    ...
    return (React__default.createElement("div", null,
        React__default.createElement(Modal, { isFullScreenOnMobile: true, disabled: Object.keys(selectedMembers).length === 0, submitText: stringSet.BUTTON__INVITE, type: ButtonTypes.PRIMARY, onCancel: function () { return onCancel(); }, onSubmit: function () {
            ...
            React__default.createElement("div", { className: "sendbird-more-members__popup-scroll", onScroll: function (e) {
                ...
                React__default.createElement("div", { className: "sendbird-more-members__popup-scroll__inner" }, members.map(function (member) {
                    var _a;
                    ...
                    return (React__default.createElement(UserListItem, { checkBox: true, checked: isJoinedMember || selectedMembers[member.userId], disabled: isJoinedMember, onChange: function (event) {
                            var _a;
...
//# sourceMappingURL=bundle-tUJWK_IX.js.map
