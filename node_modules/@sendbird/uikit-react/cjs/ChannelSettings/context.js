...
var ChannelSettingsContext = React.createContext(undefined);
var ChannelSettingsProvider = function (props) {
    ...
    var _b = React.useState(uuid.uuidv4()), channelUpdateId = _b[0], setChannelUpdateId = _b[1];
    var _c = React.useState(null), channel = _c[0], setChannel = _c[1];
    var _d = React.useState(false), invalidChannel = _d[0], setInvalidChannel = _d[1];
    ...
    return (React.createElement(ChannelSettingsContext.Provider, { value: {
        ...
        React.createElement(UserProfileContext.UserProfileProvider, { renderUserProfile: props === null || props === void 0 ? void 0 : props.renderUserProfile, disableUserProfile: (_a = props === null || props === void 0 ? void 0 : props.disableUserProfile) !== null && _a !== void 0 ? _a : config === null || config === void 0 ? void 0 : config.disableUserProfile, onUserProfileMessage: onUserProfileMessage },
