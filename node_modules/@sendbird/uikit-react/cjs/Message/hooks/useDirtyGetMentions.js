...
function useDirtyGetMentions(_a, _b) {
    ...
    var _c = React.useState([]), mentionNodes = _c[0], setMentionNodes = _c[1];
    ...
    React.useEffect(function () {
        ...
        if (targetNode) {
            ...
            logger.info('useDirtyGetMentions: observer started', { observer: observer, config: config });
        }
        return function () {
            try {
                observer.disconnect();
                logger.info('useDirtyGetMentions: observer disconnected', { observer: observer });
            }
            catch (error) {
