...
var VoicePlayer_context = require('./chunks/bundle-VoZZnYtF.js');
...
var stringSet = require('./chunks/bundle-v8bBiJ_c.js');
var consts = require('./chunks/bundle-EVdeXpsD.js');
var resolvedReplyType = require('./chunks/bundle-l92Ws-Rs.js');
...
function useOnlineStatus(sdk, logger) {
    var _a, _b;
    var _c = React.useState((_b = (_a = window === null || window === void 0 ? void 0 : window.navigator) === null || _a === void 0 ? void 0 : _a.onLine) !== null && _b !== void 0 ? _b : true), isOnline = _c[0], setIsOnline = _c[1];
    React.useEffect(function () {
        var uniqueHandlerId = uuid.uuidv4();
        try {
            logger.warning('sdk changed', uniqueHandlerId);
            var handler = new SendbirdChat.ConnectionHandler({
        ...
        return _tslib.__generator(this, function (_c) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    if (userId && appId) {
                        ...
                        var connectCbSucess_1 = function (user) { return _tslib.__awaiter(_this, void 0, void 0, function () {
                            var _a, _b;
                            return _tslib.__generator(this, function (_c) {
...
var VoiceMessageProvider = function (_a) {
    ...
    if (!isVoiceMessageEnabled) {
        return (React.createElement(VoicePlayer_context.VoicePlayerProvider, null, children));
    }
    return (React.createElement(VoiceRecorder_context.VoiceRecorderProvider, null,
        React.createElement(VoicePlayer_context.VoicePlayerProvider, null, children)));
};
...
function uikitConfigMapper(_a) {
    ...
    return {
        ...
        groupChannel: {
            ...
            replyType: (_o = (_m = uikitOptions.groupChannel) === null || _m === void 0 ? void 0 : _m.replyType) !== null && _o !== void 0 ? _o : (replyType != null ? resolvedReplyType.getCaseResolvedReplyType(replyType).lowerCase : undefined),
...
function useMarkAsReadScheduler(_a, _b) {
    ...
    var markAsReadScheduler = React.useMemo(function () { return schedulerFactory({
        logger: logger,
        cb: function (channel) {
            try {
                channel.markAsRead();
...
function useMarkAsDeliveredScheduler(_a, _b) {
    var isConnected = _a.isConnected;
    var logger = _b.logger;
    var markAsDeliveredScheduler = React.useMemo(function () { return schedulerFactory({
        logger: logger,
        cb: function (channel) {
            try {
...
function SendbirdProvider(props) {
    ...
    return (React.createElement(uikitTools.UIKitConfigProvider, { localConfigs: {
...
var SendbirdSDK = function (_a) {
    ...
    var pubSub = React.useState(function () { return customPubSub !== null && customPubSub !== void 0 ? customPubSub : pubSubFactory(); })[0];
    var _1 = React.useReducer(reducer$1, initialState$1), sdkStore = _1[0], sdkDispatcher = _1[1];
    var _2 = React.useReducer(reducer, initialState), userStore = _2[0], userDispatcher = _2[1];
    var _3 = uikitTools.useUIKitConfig(), configs = _3.configs, configsWithAppAttr = _3.configsWithAppAttr, initDashboardConfigs = _3.initDashboardConfigs;
    ...
    var _5 = React.useState(theme), currentTheme = _5[0], setCurrentTheme = _5[1];
    React.useEffect(function () {
    ...
    return (React.createElement(withSendbird.SendbirdSdkContext.Provider, { value: {
            ...
            config: {
                ...
                logger: logger,
                pubSub: pubSub,
                imageCompression: _tslib.__assign({ compressionRate: 0.7 }, imageCompression),
                voiceRecord: {
                ...
                groupChannel: {
                    ...
                    threadReplySelectType: resolvedReplyType.getCaseResolvedThreadReplySelectType(configs.groupChannel.channel.threadReplySelectType).lowerCase,
        ...
        React.createElement(MediaQueryContext.MediaQueryProvider, { logger: logger, breakpoint: breakpoint },
            React.createElement(LocalizationContext.LocalizationProvider, { stringSet: localeStringSet, dateLocale: dateLocale },
                React.createElement(VoiceMessageProvider, { isVoiceMessageEnabled: configs.groupChannel.channel.enableVoiceMessage },
                    React.createElement(hooks_useModal.GlobalModalProvider, null, children))))));
};
