...
var color = require('../../chunks/bundle-yTYZiuXi.js');
...
function ParentMessageInfoItem(_a) {
    ...
    var threadMessageKindKey = useStatefulFileInfoList.useThreadMessageKindKeySelector({
        threadMessageKind: useStatefulFileInfoList.ThreadMessageKind.PARENT,
        isMobile: isMobile,
    });
    ...
    return (React.createElement("div", { className: "sendbird-parent-message-info-item ".concat(className) },
        ...
        index.isThumbnailMessage(message) && (React.createElement("div", { className: "sendbird-parent-message-info-item__thumbnail-message", onClick: function () {
            ...
            React.createElement(ui_ImageRenderer.default, { className: "sendbird-parent-message-info-item__thumbnail-message__thumbnail", url: thumbnailUrl || (message === null || message === void 0 ? void 0 : message.url) || (message === null || message === void 0 ? void 0 : message.plainUrl), alt: message === null || message === void 0 ? void 0 : message.type, width: "200px", height: "148px", onLoad: function () { setImageRendered(true); }, placeHolder: function (style_) { return (React.createElement("div", { className: "sendbird-parent-message-info-item__thumbnail-message__placeholder", style: style_ },
