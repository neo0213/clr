...
var useSendMultipleFilesMessage = require('../chunks/bundle-tFuTz5CT.js');
...
var pubSub_topics = require('../chunks/bundle-0wbO-LdY.js');
var actionTypes = require('../chunks/bundle-GE1I3PNS.js');
var groupChannel = require('@sendbird/chat/groupChannel');
var uuid = require('../chunks/bundle-NYFm08XH.js');
var compareIds = require('../chunks/bundle-ow5FLcVV.js');
    ...
    var sendMessage = React.useCallback(function (file, quoteMessage) {
        return new Promise(function (resolve, reject) {
            ...
            currentChannel === null || currentChannel === void 0 ? void 0 : currentChannel.sendFileMessage(params).onPending(function (pendingMessage) {
                ...
                setTimeout(function () { return useSendMultipleFilesMessage.scrollIntoLast(); }, 1000);
...
function useGetPrevThreadsCallback(_a, _b) {
    ...
    return React.useCallback(function (callback) {
        var _a;
        // validation check
        if (threadListState === Thread_context_types.ThreadListStateTypes.INITIALIZED
