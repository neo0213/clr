...
var stringSet = require('./bundle-v8bBiJ_c.js');
...
function Label(_a) {
    ...
    React.createElement("span", { className: _tslib.__spreadArray(_tslib.__spreadArray([], (Array.isArray(className) ? className : [className]), true), [
            'sendbird-label',
...
//# sourceMappingURL=bundle-0MHADZvF.js.map
