...
var resolvedReplyType = require('./bundle-l92Ws-Rs.js');
var useSendMultipleFilesMessage = require('./bundle-tFuTz5CT.js');
...
function channelReducer(state, action) {
    return index_module.K(action)
        ...
        .with({
        type: index_module.S.union(actionTypes.FETCH_INITIAL_MESSAGES_FAILURE, actionTypes.FETCH_PREV_MESSAGES_FAILURE, actionTypes.FETCH_NEXT_MESSAGES_FAILURE),
    }, function (action) {
        var _a;
        ...
        return _tslib.__assign(_tslib.__assign({}, state), { allMessages: state.allMessages.map(function (m) { return compareIds.compareIds(hasReqId(m) && m.reqId, action.payload.reqId)
                ? action.payload
                : m; }) });
    })
...
var ChannelProvider = function (props) {
    ...
    var resendMessage = useResendMessageCallback({ currentGroupChannel: currentGroupChannel, messagesDispatcher: messagesDispatcher }, { logger: logger });
...
//# sourceMappingURL=bundle-7gBYfQwU.js.map
