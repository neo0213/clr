...
var getMimeTypesUIKitAccepts = function (acceptableMimeTypes) {
    ...
    if (Array.isArray(acceptableMimeTypes) && acceptableMimeTypes.length > 0) {
        return (acceptableMimeTypes
            .reduce(function (accumulator, acceptableMimeType) { return (accumulator.concat(index_module.K(acceptableMimeType)
            .with('image', function () { return IMAGE; })
            .with('video', function () { return VIDEO; })
            .with('audio', function () { return AUDIO; })
            .otherwise(function () { return []; }))); }, [])
            .join());
    }
    return (Object.values(SUPPORTED_MIMES)
        .reduce(function (accumulator, mimeTypes) { return (accumulator.concat(mimeTypes)); }, [])
        .join());
...
//# sourceMappingURL=bundle-F--qTOLe.js.map
