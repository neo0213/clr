...
var compareIds = require('./bundle-ow5FLcVV.js');
...
var isSameGroup = function (message, comparingMessage) {
    ...
    if (!(message
        ...
        && (comparingMessage === null || comparingMessage === void 0 ? void 0 : comparingMessage.messageType)
    ...
    return ((message_ === null || message_ === void 0 ? void 0 : message_.sendingStatus) === (comparingMessage_ === null || comparingMessage_ === void 0 ? void 0 : comparingMessage_.sendingStatus)
        && ((_c = message_ === null || message_ === void 0 ? void 0 : message_.sender) === null || _c === void 0 ? void 0 : _c.userId) === ((_d = comparingMessage_ === null || comparingMessage_ === void 0 ? void 0 : comparingMessage_.sender) === null || _d === void 0 ? void 0 : _d.userId)
        && (getMessageCreatedAt(message) === getMessageCreatedAt(comparingMessage)));
};
var compareMessagesForGrouping = function (prevMessage, currMessage, nextMessage) { return ([
...
function useSendMessageCallback(_a, _b) {
    var currentOpenChannel = _a.currentOpenChannel, onBeforeSendUserMessage = _a.onBeforeSendUserMessage, checkScrollBottom = _a.checkScrollBottom, messageInputRef = _a.messageInputRef;
    var sdk = _b.sdk, logger = _b.logger, messagesDispatcher = _b.messagesDispatcher, scrollRef = _b.scrollRef;
    return React.useCallback(function () {
        if (sdk) {
...
function useFileUploadCallback(_a, _b) {
    var currentOpenChannel = _a.currentOpenChannel, checkScrollBottom = _a.checkScrollBottom, _c = _a.imageCompression, imageCompression = _c === void 0 ? {} : _c, onBeforeSendFileMessage = _a.onBeforeSendFileMessage;
    var sdk = _b.sdk, logger = _b.logger, messagesDispatcher = _b.messagesDispatcher, scrollRef = _b.scrollRef;
    return React.useCallback(function (files) {
        if (sdk) {
            ...
            var compressionRate_1 = imageCompression.compressionRate, resizingWidth_1 = imageCompression.resizingWidth, resizingHeight_1 = imageCompression.resizingHeight;
            ...
            var compressibleDiamensions_1 = pxToNumber(resizingWidth_1)
                || pxToNumber(resizingHeight_1);
                ...
                try {
                    ...
                    image_1.onload = function () {
                        ...
                        context.canvas.toBlob(function (newImageBlob) {
                            var compressedFile = new File([newImageBlob], file_1.name, { type: file_1.type });
...
//# sourceMappingURL=bundle-KVlEj9_l.js.map
