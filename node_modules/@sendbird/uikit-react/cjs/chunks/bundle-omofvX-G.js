...
var ui_FileViewer = require('./bundle-5cuVj6Hi.js');
...
function MultipleFilesMessageItemBody(_a) {
    ...
    return threadMessageKindKey && (React.createElement(React.Fragment, null,
        ...
        React.createElement(ImageGrid, { className: className, message: message$1, isReactionEnabled: isReactionEnabled }, statefulFileInfoList.map(function (fileInfo, index$1) {
            ...
            return React.createElement("div", { className: 'sendbird-multiple-files-image-renderer-wrapper', onClick: message$1.sendingStatus === message.SendingStatus.SUCCEEDED
                    ? function () { return setCurrentFileViewerIndex(index$1); }
                    : undefined, key: "sendbird-multiple-files-image-renderer-".concat(index$1, "-").concat(fileInfo.url) },
                React.createElement(ui_ImageRenderer.default, { url: fileInfo.url, fixedSize: false, width: MULTIPLE_FILES_IMAGE_SIDE_LENGTH[threadMessageKindKey], maxSideLength: MULTIPLE_FILES_IMAGE_SIDE_LENGTH.CHAT_WEB, height: MULTIPLE_FILES_IMAGE_SIDE_LENGTH[threadMessageKindKey], borderRadius: ui_ImageRenderer.getBorderRadiusForMultipleImageRenderer(MULTIPLE_FILES_IMAGE_BORDER_RADIUS[threadMessageKindKey], index$1, statefulFileInfoList.length), shadeOnHover: true, isUploaded: !!fileInfo.isUploaded, placeHolder: function (style_) { return (React.createElement("div", { className: "sendbird-multiple-files-image-renderer__thumbnail__placeholder", style: style_ }, isGifValue
                        ...
                        : React.createElement(ui_Icon.default, { type: ui_Icon.IconTypes.PHOTO, fillColor: ui_Icon.IconColors.ON_BACKGROUND_2, width: MULTIPLE_FILES_IMAGE_THUMBNAIL_SIDE_LENGTH, height: MULTIPLE_FILES_IMAGE_THUMBNAIL_SIDE_LENGTH }))); }, defaultComponent: React.createElement("div", { className: "sendbird-multiple-files-image-renderer__thumbnail__placeholder" }, React.createElement(ui_Icon.default, { type: ui_Icon.IconTypes.THUMBNAIL_NONE, fillColor: ui_Icon.IconColors.ON_BACKGROUND_2, width: MULTIPLE_FILES_IMAGE_THUMBNAIL_SIDE_LENGTH, height: MULTIPLE_FILES_IMAGE_THUMBNAIL_SIDE_LENGTH })) }));
        }))));
}
...
function useThreadMessageKindKeySelector(_a) {
    ...
    var threadMessageKindKey = React.useMemo(function () {
        return index_module.K(threadMessageKind)
...
function createStatefulFileInfoList(message$1, oldStatefulFileInfoList) {
    ...
    if (!Array.isArray((_a = message$1.messageParams) === null || _a === void 0 ? void 0 : _a.fileInfoList))
        return null;
    return message$1.messageParams.fileInfoList
...
var useStatefulFileInfoList = function (message) {
    var _a, _b, _c;
    var _d = React.useState([]), statefulFileInfoList = _d[0], setStatefulFileInfoList = _d[1];
...
//# sourceMappingURL=bundle-omofvX-G.js.map
