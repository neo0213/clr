...
require('./bundle-pOTnhSyt.js');
var ui_Avatar = require('./bundle-vSdu8rrq.js');
require('react-dom');
require('./bundle-vWUmeH2R.js');
    ...
    return (React.createElement("div", { className: "sendbird-participants-accordion__member" },
        React.createElement("div", { className: "sendbird-participants-accordion__member-avatar" },
            React.createElement(ui_ContextMenu.default, { menuTrigger: function (toggleDropdown) { return (React.createElement(React.Fragment, null,
                    ...
                    (user === null || user === void 0 ? void 0 : user.isMuted) ? (React.createElement(ui_MutedAvatarOverlay, null)) : '')); }, menuItems: function (closeDropdown) { return (React.createElement(ui_ContextMenu.MenuItems, { openLeft: true, parentRef: avatarRef, 
                    // for catching location(x, y) of MenuItems
                    parentContainRef: avatarRef, 
                    // for toggling more options(menus & reactions)
                    closeDropdown: closeDropdown, style: { paddingTop: '0px', paddingBottom: '0px' } }, renderUserProfile
                    ? renderUserProfile({
                        user: user,
...
//# sourceMappingURL=bundle-ugapct3R.js.map
