...
var pxToNumber = require('./bundle-MeuNh9Q9.js');
...
var AvatarInner = function (_a) {
    ...
    if (src && src.length) {
        ...
        return (React.createElement("div", { className: "sendbird-avatar--inner__four-child" }, src.slice(0, 4)
            .map(function (i) { return (React.createElement(ui_ImageRenderer.default, { className: imageRendererClassName, url: i, height: height, width: width, alt: alt, key: uuid.uuidv4(), defaultComponent: defaultComponent })); })));
    }
    // default img
...
//# sourceMappingURL=bundle-vSdu8rrq.js.map
