...
function Button(_a) {
    var className = _a.className, _b = _a.type, type = _b === void 0 ? exports.ButtonTypes.PRIMARY : _b, _c = _a.size, size = _c === void 0 ? exports.ButtonSizes.BIG : _c, _d = _a.children, children = _d === void 0 ? 'Button' : _d, _e = _a.disabled, disabled = _e === void 0 ? false : _e, _f = _a.onClick, onClick = _f === void 0 ? function () { } : _f;
    ...
    return (React.createElement("button", { className: injectingClassNames, type: "button", onClick: onClick, disabled: disabled },
        React.createElement(ui_Label.Label, { className: "sendbird-button__text", type: ui_Label.LabelTypography.BUTTON_1, color: ui_Label.LabelColors.ONCONTENT_1 }, children)));
}
