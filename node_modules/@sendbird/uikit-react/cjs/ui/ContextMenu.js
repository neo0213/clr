...
var MenuItems$1 = /** @class */ (function (_super) {
    ...
    MenuItems.prototype.render = function () {
        ...
        return (reactDom.createPortal((React.createElement("div", { className: (_a = this.props) === null || _a === void 0 ? void 0 : _a.className },
            React.createElement("div", { className: "sendbird-dropdown__menu-backdrop" }),
            React.createElement("ul", { className: "".concat(className, " sendbird-dropdown__menu"), ref: this.menuRef, style: _tslib.__assign({ display: 'inline-block', position: 'fixed', left: "".concat(Math.round(menuStyle.left), "px"), top: "".concat(Math.round(menuStyle.top), "px") }, style) }, children))), document.getElementById('sendbird-dropdown-portal')));
    };
    return MenuItems;
}(React.Component));
