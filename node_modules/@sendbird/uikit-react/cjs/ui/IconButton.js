...
var IconButton = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement("button", { className: _tslib.__spreadArray(_tslib.__spreadArray([], (Array.isArray(className) ? className : [className]), true), [
            'sendbird-iconbutton',
        ...
        React.createElement("span", { className: "sendbird-iconbutton__inner" }, children)));
});
