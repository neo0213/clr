...
var ui_MessageInput_hooks_usePaste = require('../chunks/bundle-HjwY9t7s.js');
...
var checkIfFileUploadEnabled = function (_a) {
    ...
    var isEnabled = index_module.K(channel === null || channel === void 0 ? void 0 : channel.channelType)
...
var MessageInput = React.forwardRef(function (props, externalRef) {
    var _a, _b, _c, _d, _e;
    var channel = props.channel, _f = props.className, className = _f === void 0 ? '' : _f, _g = props.messageFieldId, messageFieldId = _g === void 0 ? '' : _g, _h = props.isEdit, isEdit = _h === void 0 ? false : _h, _j = props.isMentionEnabled, isMentionEnabled = _j === void 0 ? false : _j, _k = props.isVoiceMessageEnabled, isVoiceMessageEnabled = _k === void 0 ? true : _k, _l = props.isSelectingMultipleFilesEnabled, isSelectingMultipleFilesEnabled = _l === void 0 ? false : _l, _m = props.disabled, disabled = _m === void 0 ? false : _m, _o = props.message, message = _o === void 0 ? null : _o, _p = props.placeholder, placeholder = _p === void 0 ? '' : _p, _q = props.maxLength, maxLength = _q === void 0 ? 5000 : _q, _r = props.onFileUpload, onFileUpload = _r === void 0 ? noop : _r, _s = props.onSendMessage, onSendMessage = _s === void 0 ? noop : _s, _t = props.onUpdateMessage, onUpdateMessage = _t === void 0 ? noop : _t, _u = props.onCancelEdit, onCancelEdit = _u === void 0 ? noop : _u, _v = props.onStartTyping, onStartTyping = _v === void 0 ? noop : _v, _w = props.channelUrl, channelUrl = _w === void 0 ? '' : _w, _x = props.mentionSelectedUser, mentionSelectedUser = _x === void 0 ? null : _x, _y = props.onUserMentioned, onUserMentioned = _y === void 0 ? noop : _y, _z = props.onMentionStringChange, onMentionStringChange = _z === void 0 ? noop : _z, _0 = props.onMentionedUserIdsUpdated, onMentionedUserIdsUpdated = _0 === void 0 ? noop : _0, _1 = props.onVoiceMessageIconClick, onVoiceMessageIconClick = _1 === void 0 ? noop : _1, _2 = props.onKeyUp, onKeyUp = _2 === void 0 ? noop : _2, _3 = props.onKeyDown, onKeyDown = _3 === void 0 ? noop : _3, _4 = props.renderFileUploadIcon, renderFileUploadIcon = _4 === void 0 ? noop : _4, _5 = props.renderVoiceMessageIcon, renderVoiceMessageIcon = _5 === void 0 ? noop : _5, _6 = props.renderSendMessageIcon, renderSendMessageIcon = _6 === void 0 ? noop : _6, _7 = props.setMentionedUsers, setMentionedUsers = _7 === void 0 ? noop : _7, _8 = props.acceptableMimeTypes, acceptableMimeTypes = _8 === void 0 ? null : _8;
        ...
        if (!isEdit && (textField === null || textField === void 0 ? void 0 : textField.textContent)) {
            ...
            textField.childNodes.forEach(function (node) {
                if (node.nodeType === _const$1.NodeTypes.ElementNode && node.nodeName === _const$1.NodeNames.Span) {
                    ...
                    messageText_1 += innerText;
                    mentionTemplate_1 += "".concat(_const.USER_MENTION_TEMP_CHAR, "{").concat(userid, "}");
                }
                    ...
                    messageText_1 += textContent;
                    mentionTemplate_1 += textContent;
                }
            });
            var params = { message: messageText_1, mentionTemplate: mentionTemplate_1 };
    ...
    var editMessage = function () {
        ...
        if (isEdit && messageId) {
            var messageText_2 = '';
            var mentionTemplate_2 = '';
            textField.childNodes.forEach(function (node) {
                if (node.nodeType === _const$1.NodeTypes.ElementNode && node.nodeName === _const$1.NodeNames.Span) {
                    // @ts-ignore
                    var innerText = node.innerText, _a = node.dataset, dataset = _a === void 0 ? {} : _a;
                    var _b = dataset.userid, userid = _b === void 0 ? '' : _b;
                    messageText_2 += innerText;
                    mentionTemplate_2 += "".concat(_const.USER_MENTION_TEMP_CHAR, "{").concat(userid, "}");
                    messageText_2 += '\n';
                    mentionTemplate_2 += '\n';
                }
                else {
                    // other nodes including text node
                    var _c = node.textContent, textContent = _c === void 0 ? '' : _c;
                    messageText_2 += textContent;
                    mentionTemplate_2 += textContent;
                }
            });
            var params = { messageId: messageId, message: messageText_2, mentionTemplate: mentionTemplate_2 };
    ...
    return (React.createElement("form", { className: index.getClassName([
            className,
            isEdit ? 'sendbird-message-input__edit' : '',
            disabled ? 'sendbird-message-input-form__disabled' : '',
        ]) },
        React.createElement("div", { className: index.getClassName(['sendbird-message-input', disabled ? 'sendbird-message-input__disabled' : '']) },
                    ...
                    || (isFileUploadEnabled && (React.createElement(ui_IconButton, { className: "sendbird-message-input--attach ".concat(isVoiceMessageEnabled ? 'is-voice-message-enabled' : ''), height: "32px", width: "32px", onClick: function () {
                        ...
                        React.createElement("input", { className: "sendbird-message-input--attach-input", type: "file", ref: fileInputRef, 
                            ...
                            onChange: function (event) {
                                ...
                                event.target.value = '';
                            }, accept: index.getMimeTypesUIKitAccepts(acceptableMimeTypes), multiple: isSelectingMultipleFilesEnabled && ui_MessageInput_hooks_usePaste.isChannelTypeSupportsMultipleFilesMessage(channel) }))))),
