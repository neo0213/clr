...
var utils = require('../chunks/bundle-KKPmuuwX.js');
...
function ThumbnailMessageItemBody(_a) {
    ...
    return (React.createElement("div", _tslib.__assign({ className: index.getClassName([
        ...
        React.createElement(ui_ImageRenderer.default, { className: "sendbird-thumbnail-message-item-body__thumbnail", url: thumbnailUrl || utils.getMessageFirstFileUrl(message), alt: utils.getMessageFirstFileType(message), width: (style === null || style === void 0 ? void 0 : style.width) || '360px', height: (style === null || style === void 0 ? void 0 : style.height) || '270px', onLoad: function () { setImageRendered(true); }, placeHolder: function (style_) { return (React.createElement("div", { className: "sendbird-thumbnail-message-item-body__placeholder", style: style_ })); } }),
