...
var ToggleContext = React.createContext(TOGGLE_DEFAULT_VALUE);
...
function ToggleContainer(_a) {
    ...
    var _h = React.useState(defaultChecked || false), isChecked = _h[0], setChecked = _h[1];
    ...
    return (React.createElement(ToggleContext.Provider, { value: {
...
function ToggleUI(props) {
    ...
    var _l = React.useState(''), animatedClassName = _l[0], setAnimatedClassName = _l[1];
    ...
    return (React.createElement("label", { className: [
        ...
        ].flat().join(' '), style: _tslib.__assign({ width: "".concat(toggleWidth, "px"), height: "".concat(toggleHeight, "px"), borderRadius: "".concat(dotSize, "px") }, style) },
        ...
        React.createElement("input", { type: "checkbox", "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, name: name, id: id, checked: checked, disabled: disabled, onChange: function (e) {
                onChange(e);
...
function Toggle(props) {
    ...
    return (React.createElement("div", { className: "sendbird-ui-toggle ".concat(className) },
        React.createElement(ToggleContainer, { checked: checked, defaultChecked: defaultChecked, disabled: disabled, onChange: onChange, onFocus: onFocus, onBlur: onBlur },
            React.createElement(ToggleUI, { reversed: reversed, width: width, animationDuration: animationDuration, style: style, name: name, id: id, ariaLabel: ariaLabel, ariaLabelledby: ariaLabelledby }))));
}
