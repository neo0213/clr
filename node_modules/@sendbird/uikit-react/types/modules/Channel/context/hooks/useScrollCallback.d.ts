...
declare function useScrollCallback({ currentGroupChannel, oldestMessageTimeStamp, userFilledMessageListQuery, replyType }: UseScrollCallbackOptions, { hasMorePrev, logger, messagesDispatcher, sdk }: UseScrollCallbackParams): () => void;
