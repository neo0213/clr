...
export declare const isSameGroup: (message: SendableMessageType | BaseMessage, comparingMessage: SendableMessageType | BaseMessage, currentChannel: GroupChannel) => boolean;
