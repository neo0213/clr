...
declare function useFileUploadCallback({ currentOpenChannel, checkScrollBottom, imageCompression, onBeforeSendFileMessage, }: DynamicParams, { sdk, logger, messagesDispatcher, scrollRef }: StaticParams): CallbackReturn;
