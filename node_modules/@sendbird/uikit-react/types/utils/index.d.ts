...
import { GroupChannel, SendbirdGroupChat, GroupChannelListQuery } from '@sendbird/chat/groupChannel';
...
export declare const getMimeTypesUIKitAccepts: (acceptableMimeTypes?: Array<string>) => string;
...
export declare function getSuggestedReplies(message?: EveryMessage): string[];
...
export declare const binarySearch: (list: Array<number>, number: number) => number;
export declare const getChannelsWithUpsertedChannel: (channels: Array<GroupChannel>, channel: GroupChannel) => Array<GroupChannel>;
