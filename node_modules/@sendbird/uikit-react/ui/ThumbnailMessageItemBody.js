...
import { k as isSentMessage, n as getClassName, x as isVideoMessage, y as isGifMessage } from '../chunks/bundle-ZT6XnGSN.js';
import { n as noop } from '../chunks/bundle-JhG5BHdE.js';
import { u as useLongPress } from '../chunks/bundle-cJc3JBZb.js';
import { c as getMessageFirstFileThumbnailUrl, g as getMessageFirstFileUrl, a as getMessageFirstFileType } from '../chunks/bundle-WZvwkbYN.js';
...
function ThumbnailMessageItemBody(_a) {
    ...
    return (React__default.createElement("div", __assign({ className: getClassName([
        ...
        React__default.createElement(ImageRenderer, { className: "sendbird-thumbnail-message-item-body__thumbnail", url: thumbnailUrl || getMessageFirstFileUrl(message), alt: getMessageFirstFileType(message), width: (style === null || style === void 0 ? void 0 : style.width) || '360px', height: (style === null || style === void 0 ? void 0 : style.height) || '270px', onLoad: function () { setImageRendered(true); }, placeHolder: function (style_) { return (React__default.createElement("div", { className: "sendbird-thumbnail-message-item-body__placeholder", style: style_ })); } }),
