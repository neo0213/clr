...
var actionTypes = require('./actionTypes-3741798e.js');
var index$5 = require('./index-5f328810.js');
var index = require('./index-ab6bb60c.js');
var index$4 = require('./index-3a5946e7.js');
var LeaveChannel = require('./LeaveChannel-c874273a.js');
var index$3 = require('./index-fd4db281.js');
var index$1 = require('./index-d868ada3.js');
var index$2 = require('./index-ee452a1f.js');
var index$6 = require('./index-5334ea42.js');
require('react-dom');
require('./utils-9568050d.js');
...
var getChannelTitle = function getChannelTitle() {
  ...
  var stringSet = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : index$3.LabelStringSet;
...
function ChannelPreviewAction(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    menuTrigger: function menuTrigger(toggleDropdown) {
      return /*#__PURE__*/React__default["default"].createElement(index$5.IconButton, {
        ref: parentRef,
    ...
    menuItems: function menuItems(closeDropdown) {
      return /*#__PURE__*/React__default["default"].createElement(index$5.MenuItems, {
        parentRef: parentRef,
...
var pubSubHandler = function pubSubHandler(pubSub, channelListDispatcher) {
  ...
  subScriber.set(index$5.CREATE_CHANNEL, pubSub.subscribe(index$5.CREATE_CHANNEL, function (msg) {
  ...
  subScriber.set(index$5.UPDATE_USER_MESSAGE, pubSub.subscribe(index$5.UPDATE_USER_MESSAGE, function (msg) {
  ...
  subScriber.set(index$5.LEAVE_CHANNEL, pubSub.subscribe(index$5.LEAVE_CHANNEL, function (msg) {
    var channel = msg.channel;
    channelListDispatcher({
  ...
  subScriber.set(index$5.SEND_MESSAGE_START, pubSub.subscribe(index$5.SEND_MESSAGE_START, function (msg) {
    var channel = msg.channel;
    channelListDispatcher({
